      ...
      <table id="example2" class="table table-bordered table-hover">
        ...
        @foreach ($food as $fd)
            <tr>
                ...
                <td>
                    @if (($fd->food_status==1))
                      <a class="btn btn-outline-success" href="{{route('inactive_fd', ['food_id'=>$fd->food_id])}}"><i class=" fas fa-arrow-up "></i></a>
                    @else
                      <a class="btn btn-outline-info" href="{{route('active_fd', ['food_id'=>$fd->food_id])}}"><i class=" fas fa-arrow-down "></i></a>
                    @endif
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <form action="{{route('update_fd')}}" method="post" enctype="multipart/form-data">
                              @csrf
                    ...
                    <a class=" btn btn-outline-danger " id="delete" href="{{route('delete_fd', ['food_id'=>$fd->food_id])}}" title="Click Để Xóa"><i class=" fas fa-trash "></i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
