...
<head>
    ...
    <link href="{{asset('/')}}FrontEndSourceFile/css/font-awesome.css" rel="stylesheet">
    <!-- font-awesome icons -->
    ...
    <!-- //js -->
    <!-- web-fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Overpass:wght@500;900&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Overpass:wght@500;900&display=swap" rel="stylesheet">
    <!-- //web-fonts -->
</head>
