...
class ManagerFoodController extends Controller
{
    public function index(){
        ...
        return view('Manager.food.add',compact('categories'));
    }
    ...
    public function manage(){
        ...
        return view("Manager.food.manage",compact('food', 'categories'));
    }
    ...
    public function update(Request $request){
        ...
        return redirect('manager/food/manage')->with('sms', 'Món Ăn Đã Được Chỉnh Sửa');
    }
